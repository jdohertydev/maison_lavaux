...
class TestCustomClearableFileInput(TestCase):
    ...
    def test_widget_render_in_form(self):
        ...
        self.assertIn('id="id_image"', rendered)  # Ensures the ID is correctly set
        self.assertIn('name="image"', rendered)  # Ensures the name attribute is correctly set
        self.assertIn('type="file"', rendered)  # Ensures it is a file input field
