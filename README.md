...
|------|------------|---------------------|--------|
| Epic 1: [Name of Epic] | As a [user type], I can [goal] so that [reason/benefit]. | - [Criteria 1]<br>- [Criteria 2]<br>- [Criteria 3] | PASS |
| Epic 2: [Name of Epic] | As a [user type], I can [goal] so that [reason/benefit]. | - [Criteria 1]<br>- [Criteria 2]<br>- [Criteria 3] | PASS |
| Epic 3: [Name of Epic] | As a [user type], I can [goal] so that [reason/benefit]. | - [Criteria 1]<br>- [Criteria 2]<br>- [Criteria 3] | PASS |
