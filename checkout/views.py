...
def cache_checkout_data(request):
    """
    Cache checkout data in the PaymentIntent for metadata.
    """
    try:
            ...
            try:
                for item_id, item_data in bag.items():
                    ...
                    if isinstance(item_data, int):
                        ...
                        sales_data.revenue_generated += (
                            product.price * item_data
                        )
                        sales_data.save()
                    else:
...
def checkout_success(request, order_number):
    """
    Handle successful checkouts and render a confirmation page.
    """
    ...
    if request.user.is_authenticated:
        try:
            ...
            messages.error(
                request,
                "User profile not found. Please update your profile manually.",
            )
